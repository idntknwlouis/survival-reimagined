...
public class ThinRadiatedVinesBlock extends Block {
    ...
    public void neighborChanged(BlockState state, Level level, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
        ...
        if (level.getBlockState(pos.below()).is(SurvivalReimaginedModBlocks.THIN_RADIATED_VINES.get())) {
            level.setBlock(pos, SurvivalReimaginedModBlocks.THIN_RADIATED_VINE_BASE.get().defaultBlockState(), 3);
        }
    }

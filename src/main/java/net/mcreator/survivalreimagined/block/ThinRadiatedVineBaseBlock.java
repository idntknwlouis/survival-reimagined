...
public class ThinRadiatedVineBaseBlock extends Block {
    ...
    public ItemStack getCloneItemStack(LevelReader level, BlockPos pos, BlockState state) {
        return new ItemStack(SurvivalReimaginedModBlocks.THIN_RADIATED_VINES.get().asItem());
    }
    ...
    public boolean canSurvive(BlockState state, LevelReader level, BlockPos pos) {
        ...
        return above.canOcclude()
                || above.is(SurvivalReimaginedModBlocks.THIN_RADIATED_VINES.get())
                || above.is(SurvivalReimaginedModBlocks.THIN_RADIATED_VINE_BASE.get());
    }
    ...
    public void neighborChanged(BlockState state, Level level, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
        ...
        if (level.isEmptyBlock(pos.below())) {
            level.setBlock(pos, SurvivalReimaginedModBlocks.THIN_RADIATED_VINES.get().defaultBlockState(), 3);
        }
    }
}

...
public final class SurvivalReimaginedModBlocks {
	...
	public static final RegistryEntry<Block> BASALT_STALAGMITE_BASE = register("basalt_stalagmite_base", () -> new GeologySpikeBlock(SoundType.BASALT, 1.25f, 4.2f, true, GeologySpikeBlock.Segment.BASE, () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("basalt_stalagmite_base")), () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("basalt_stalagmite_middle")), () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("basalt_stalagmite_top"))));
	public static final RegistryEntry<Block> BASALT_STALAGMITE_MIDDLE = register("basalt_stalagmite_middle", () -> new GeologySpikeBlock(SoundType.BASALT, 1.25f, 4.2f, true, GeologySpikeBlock.Segment.MIDDLE, () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("basalt_stalagmite_base")), () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("basalt_stalagmite_middle")), () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("basalt_stalagmite_top"))));
	public static final RegistryEntry<Block> BASALT_STALAGMITE_TOP = register("basalt_stalagmite_top", () -> new GeologySpikeBlock(SoundType.BASALT, 1.25f, 4.2f, true, GeologySpikeBlock.Segment.TIP, () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("basalt_stalagmite_base")), () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("basalt_stalagmite_middle")), () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("basalt_stalagmite_top"))));
	public static final RegistryEntry<Block> BASALT_STALAGTITE_BASE = register("basalt_stalagtite_base", () -> new GeologySpikeBlock(SoundType.BASALT, 1.25f, 4.2f, false, GeologySpikeBlock.Segment.BASE, () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("basalt_stalagtite_base")), () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("basalt_stalagtite_middle")), () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("basalt_stalagtite_tip"))));
	public static final RegistryEntry<Block> BASALT_STALAGTITE_MIDDLE = register("basalt_stalagtite_middle", () -> new GeologySpikeBlock(SoundType.BASALT, 1.25f, 4.2f, false, GeologySpikeBlock.Segment.MIDDLE, () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("basalt_stalagtite_base")), () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("basalt_stalagtite_middle")), () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("basalt_stalagtite_tip"))));
	public static final RegistryEntry<Block> BASALT_STALAGTITE_TIP = register("basalt_stalagtite_tip", () -> new GeologySpikeBlock(SoundType.BASALT, 1.25f, 4.2f, false, GeologySpikeBlock.Segment.TIP, () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("basalt_stalagtite_base")), () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("basalt_stalagtite_middle")), () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("basalt_stalagtite_tip"))));
	...
	public static final RegistryEntry<Block> KIMBERLITE_STALAGMITE_BASE = register("kimberlite_stalagmite_base", () -> new GeologySpikeBlock(SoundType.STONE, 1.25f, 4.2f, true, GeologySpikeBlock.Segment.BASE, () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("kimberlite_stalagmite_base")), () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("kimberlite_stalagmite_middle")), () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("kimberlite_stalagmite_top"))));
	public static final RegistryEntry<Block> KIMBERLITE_STALAGMITE_MIDDLE = register("kimberlite_stalagmite_middle", () -> new GeologySpikeBlock(SoundType.STONE, 1.25f, 4.2f, true, GeologySpikeBlock.Segment.MIDDLE, () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("kimberlite_stalagmite_base")), () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("kimberlite_stalagmite_middle")), () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("kimberlite_stalagmite_top"))));
	public static final RegistryEntry<Block> KIMBERLITE_STALAGMITE_TOP = register("kimberlite_stalagmite_top", () -> new GeologySpikeBlock(SoundType.STONE, 1.25f, 4.2f, true, GeologySpikeBlock.Segment.TIP, () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("kimberlite_stalagmite_base")), () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("kimberlite_stalagmite_middle")), () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("kimberlite_stalagmite_top"))));
	public static final RegistryEntry<Block> KIMBERLITE_STALAGTITE_BASE = register("kimberlite_stalagtite_base", () -> new GeologySpikeBlock(SoundType.STONE, 1.25f, 4.2f, false, GeologySpikeBlock.Segment.BASE, () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("kimberlite_stalagtite_base")), () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("kimberlite_stalagtite_middle")), () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("kimberlite_stalagtite_tip"))));
	public static final RegistryEntry<Block> KIMBERLITE_STALAGTITE_MIDDLE = register("kimberlite_stalagtite_middle", () -> new GeologySpikeBlock(SoundType.STONE, 1.25f, 4.2f, false, GeologySpikeBlock.Segment.MIDDLE, () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("kimberlite_stalagtite_base")), () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("kimberlite_stalagtite_middle")), () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("kimberlite_stalagtite_tip"))));
	public static final RegistryEntry<Block> KIMBERLITE_STALAGTITE_TIP = register("kimberlite_stalagtite_tip", () -> new GeologySpikeBlock(SoundType.STONE, 1.25f, 4.2f, false, GeologySpikeBlock.Segment.TIP, () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("kimberlite_stalagtite_base")), () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("kimberlite_stalagtite_middle")), () -> BuiltInRegistries.BLOCK.get(SurvivalReimaginedMod.asResource("kimberlite_stalagtite_tip"))));

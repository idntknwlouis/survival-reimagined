...
public final class SurvivalReimaginedModBlocks {
	...
	public static final RegistryEntry<Block> BASALT_STALAGMITE_BASE = register("basalt_stalagmite_base", () -> new GeologySpikeBlock(SoundType.BASALT, 1.25f, 4.2f, true, GeologySpikeBlock.Segment.BASE, () -> BASALT_STALAGMITE_BASE.get(), () -> BASALT_STALAGMITE_MIDDLE.get(), () -> BASALT_STALAGMITE_TOP.get()));
	public static final RegistryEntry<Block> BASALT_STALAGMITE_MIDDLE = register("basalt_stalagmite_middle", () -> new GeologySpikeBlock(SoundType.BASALT, 1.25f, 4.2f, true, GeologySpikeBlock.Segment.MIDDLE, () -> BASALT_STALAGMITE_BASE.get(), () -> BASALT_STALAGMITE_MIDDLE.get(), () -> BASALT_STALAGMITE_TOP.get()));
	public static final RegistryEntry<Block> BASALT_STALAGMITE_TOP = register("basalt_stalagmite_top", () -> new GeologySpikeBlock(SoundType.BASALT, 1.25f, 4.2f, true, GeologySpikeBlock.Segment.TIP, () -> BASALT_STALAGMITE_BASE.get(), () -> BASALT_STALAGMITE_MIDDLE.get(), () -> BASALT_STALAGMITE_TOP.get()));
	public static final RegistryEntry<Block> BASALT_STALAGTITE_BASE = register("basalt_stalagtite_base", () -> new GeologySpikeBlock(SoundType.BASALT, 1.25f, 4.2f, false, GeologySpikeBlock.Segment.BASE, () -> BASALT_STALAGTITE_BASE.get(), () -> BASALT_STALAGTITE_MIDDLE.get(), () -> BASALT_STALAGTITE_TIP.get()));
	public static final RegistryEntry<Block> BASALT_STALAGTITE_MIDDLE = register("basalt_stalagtite_middle", () -> new GeologySpikeBlock(SoundType.BASALT, 1.25f, 4.2f, false, GeologySpikeBlock.Segment.MIDDLE, () -> BASALT_STALAGTITE_BASE.get(), () -> BASALT_STALAGTITE_MIDDLE.get(), () -> BASALT_STALAGTITE_TIP.get()));
	public static final RegistryEntry<Block> BASALT_STALAGTITE_TIP = register("basalt_stalagtite_tip", () -> new GeologySpikeBlock(SoundType.BASALT, 1.25f, 4.2f, false, GeologySpikeBlock.Segment.TIP, () -> BASALT_STALAGTITE_BASE.get(), () -> BASALT_STALAGTITE_MIDDLE.get(), () -> BASALT_STALAGTITE_TIP.get()));
	...
	public static final RegistryEntry<Block> KIMBERLITE_STALAGMITE_BASE = register("kimberlite_stalagmite_base", () -> new GeologySpikeBlock(SoundType.STONE, 1.25f, 4.2f, true, GeologySpikeBlock.Segment.BASE, () -> KIMBERLITE_STALAGMITE_BASE.get(), () -> KIMBERLITE_STALAGMITE_MIDDLE.get(), () -> KIMBERLITE_STALAGMITE_TOP.get()));
	public static final RegistryEntry<Block> KIMBERLITE_STALAGMITE_MIDDLE = register("kimberlite_stalagmite_middle", () -> new GeologySpikeBlock(SoundType.STONE, 1.25f, 4.2f, true, GeologySpikeBlock.Segment.MIDDLE, () -> KIMBERLITE_STALAGMITE_BASE.get(), () -> KIMBERLITE_STALAGMITE_MIDDLE.get(), () -> KIMBERLITE_STALAGMITE_TOP.get()));
	public static final RegistryEntry<Block> KIMBERLITE_STALAGMITE_TOP = register("kimberlite_stalagmite_top", () -> new GeologySpikeBlock(SoundType.STONE, 1.25f, 4.2f, true, GeologySpikeBlock.Segment.TIP, () -> KIMBERLITE_STALAGMITE_BASE.get(), () -> KIMBERLITE_STALAGMITE_MIDDLE.get(), () -> KIMBERLITE_STALAGMITE_TOP.get()));
	public static final RegistryEntry<Block> KIMBERLITE_STALAGTITE_BASE = register("kimberlite_stalagtite_base", () -> new GeologySpikeBlock(SoundType.STONE, 1.25f, 4.2f, false, GeologySpikeBlock.Segment.BASE, () -> KIMBERLITE_STALAGTITE_BASE.get(), () -> KIMBERLITE_STALAGTITE_MIDDLE.get(), () -> KIMBERLITE_STALAGTITE_TIP.get()));
	public static final RegistryEntry<Block> KIMBERLITE_STALAGTITE_MIDDLE = register("kimberlite_stalagtite_middle", () -> new GeologySpikeBlock(SoundType.STONE, 1.25f, 4.2f, false, GeologySpikeBlock.Segment.MIDDLE, () -> KIMBERLITE_STALAGTITE_BASE.get(), () -> KIMBERLITE_STALAGTITE_MIDDLE.get(), () -> KIMBERLITE_STALAGTITE_TIP.get()));
	public static final RegistryEntry<Block> KIMBERLITE_STALAGTITE_TIP = register("kimberlite_stalagtite_tip", () -> new GeologySpikeBlock(SoundType.STONE, 1.25f, 4.2f, false, GeologySpikeBlock.Segment.TIP, () -> KIMBERLITE_STALAGTITE_BASE.get(), () -> KIMBERLITE_STALAGTITE_MIDDLE.get(), () -> KIMBERLITE_STALAGTITE_TIP.get()));

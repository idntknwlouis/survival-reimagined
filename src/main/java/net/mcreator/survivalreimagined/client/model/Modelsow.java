...
public class Modelsow<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("survival_reimagined", "modelsow"), "main");
	...
	public Modelsow(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone3 = head.addOrReplaceChild("bone3",
				CubeListBuilder.create().texOffs(0, 43).addBox(-1.5F, -2.0F, -2.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 50).addBox(-1.5F, -2.25F, -3.5F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),

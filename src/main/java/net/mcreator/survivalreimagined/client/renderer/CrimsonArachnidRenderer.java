...
public class CrimsonArachnidRenderer extends MobRenderer<CrimsonArachnidEntity, SpiderModel<CrimsonArachnidEntity>> {
	...
	public CrimsonArachnidRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<>(this) {
			...
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light,
					CrimsonArachnidEntity entity, float limbSwing, float limbSwingAmount,
	...
	@Override
	protected void scale(CrimsonArachnidEntity entity, PoseStack poseStack, float partialTickTime) {
